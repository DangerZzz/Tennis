...
class CustomImageCropLib extends StatefulWidget {
  /// The image to crop
  ...
  final CustomCropShapeLib shape;
  ...
  CustomImageCropLib({
    ...
    this.shape = CustomCropShapeLib.Circle,
  ...
  @override
  _CustomImageCropLibState createState() => _CustomImageCropLibState();
}

class _CustomImageCropLibState extends State<CustomImageCropLib>
  ...
  Path _getPath(double cropWidth, double width, double height) {
    switch (widget.shape) {
      case CustomCropShapeLib.Circle:
        return Path()
          ..addOval(
            Rect.fromCircle(
