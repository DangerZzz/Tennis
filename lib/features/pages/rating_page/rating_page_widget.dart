    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: EntityStateNotifierBuilder<RatingList>(
          ...
          builder: (_, ratingList) => (ratingList?.ratingData.isNotEmpty ??
                  false)
                            ...
                            children: [
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      'Галерея славы',
                                      style:
                                          AppTextStyles().bold_16_21.copyWith(
                                                color: AppColors().primaryText,
                                              ),
                                    ),
                                    const SizedBox(
                              ...
                              EntityStateNotifierBuilder<bool>(
                                ...
                                builder: (_, isSearching) =>
                                  ...
                                  builder:
                                      (_, searchedList) =>
                                          (wm.searchController.text.length >
                                                      2 &&
                                                  (isSearching!))
                                              ? Column(
                                                  crossAxisAlignment:
